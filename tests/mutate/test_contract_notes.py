...
def test_contract_notes_05():
    staff = abjad.Staff(r"\time 3/4 c'4 r2 " r"\time 2/4 d'2 " r"\time 3/4 e'2. " r"\time 4/4 f'1")
    auxjad.mutate.contract_notes(staff, abjad.Duration((1, 8)))
    assert abjad.lilypond(staff) == abjad.String.normalize(r"""
        \new Staff
        {
...
def test_contract_notes_07():
    staff = abjad.Staff(r"\time 4/4 c'4 r2. \time 3/4 d'4 r2 \time 4/4 e'4 r2.")
    auxjad.mutate.contract_notes(staff, abjad.Duration((1, 2)))
    assert abjad.lilypond(staff) == abjad.String.normalize(r"""
        \new Staff
        {
