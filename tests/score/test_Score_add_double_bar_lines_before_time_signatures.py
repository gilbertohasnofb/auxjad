...
def test_Score_add_double_bar_lines_before_time_signatures_01():
    staff = abjad.Staff(r"\time 3/4 c'2. \time 4/4 d'1 e'1 \time 6/4 f'2. g'2.")
...
def test_Score_add_double_bar_lines_before_time_signatures_02():
    staff_1 = abjad.Staff(r"\time 3/4 c''2. \time 4/4 d''1 e''1 \time 6/4 f''2. g''2.")
    staff_2 = abjad.Staff(r"\time 3/4 c'2. \time 4/4 d'1 e'1 \time 6/4 f'2. g'2.")
...
def test_Score_add_double_bar_lines_before_time_signatures_03():
    voice_1 = abjad.Voice(r"\time 3/4 c''2. \time 4/4 d''1 e''1 \time 6/4 f''2. g''2.")
    voice_2 = abjad.Voice(r"\time 3/4 c'2. \time 4/4 d'1 e'1 \time 6/4 f'2. g'2.")
...
def test_Score_add_double_bar_lines_before_time_signatures_07():
    staff = abjad.Staff(r"\time 3/4 R1 * 3/4 \time 4/4 R1 * 2 \time 6/4 R1 * 6/4 \time 4/4 R1")
    score = auxjad.Score([staff])
    score.add_double_bar_lines_before_time_signatures()
    assert abjad.lilypond(score) == abjad.String.normalize(r"""
        \new Score
...
def test_Score_add_double_bar_lines_before_time_signatures_08():
    staff = abjad.Staff(
        r"R1 " r"\time 3/4 c'2. " r"\time 4/4 d'1 " r"e'1 " r"\time 6/4 f'2. g'2. " r"\time 2/4 a'2"
    )
...
def test_Score_add_double_bar_lines_before_time_signatures_09():
    assert (
        auxjad.Score.add_double_bar_lines_before_time_signatures
