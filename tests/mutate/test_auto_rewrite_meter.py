...
def test_auto_rewrite_meter_01():
    staff = abjad.Staff(r"c'16 d'8 e'16 f'8 g'4 a'4 b'8 " r"c'16 d'4. e'16 f'8 g'4 a'16 b'16")
...
def test_auto_rewrite_meter_02():
    staff = abjad.Staff(r"c'16 d'8 e'16 f'8 g'4 a'4 b'8 " r"\time 6/8 b'4 c''4 r4 ")
    auxjad.mutate.auto_rewrite_meter(staff)
    assert abjad.lilypond(staff) == abjad.String.normalize(r"""
        \new Staff
        {
...
def test_auto_rewrite_meter_03():
    staff = abjad.Staff(r"c'16 d'8 e'16 f'8 g'4 a'4 b'8 " r"c'16 d'4. e'16 f'8 g'4 a'16 b'16")
    abjad.mutate.auto_rewrite_meter(staff, prettify_rewrite_meter=False)
    assert abjad.lilypond(staff) == abjad.String.normalize(r"""
        \new Staff
        {
            c'16
...
def test_auto_rewrite_meter_04():
    staff = abjad.Staff(
        r"\time 7/4 c'8 d'4 e'4 f'4 g'4 a'4 b'4 c''8 " r"\time 5/4 d''8 e''4 f''4 g''4 a''4 b''8"
    )
    auxjad.mutate.auto_rewrite_meter(staff)
    assert abjad.lilypond(staff) == abjad.String.normalize(r"""
        \new Staff
...
def test_auto_rewrite_meter_08():
    ...
    abjad.mutate.auto_rewrite_meter(staff, extract_trivial_tuplets=False)
    assert abjad.lilypond(staff) == abjad.String.normalize(r"""
        \new Staff
        {
            \times 2/3
...
def test_auto_rewrite_meter_09():
    staff = abjad.Staff(r"\times 2/3 {c'2 d'1}" r"\times 2/3 {e'2} \times 2/3 {f'1}")
    abjad.mutate.auto_rewrite_meter(staff)
    assert abjad.lilypond(staff) == abjad.String.normalize(r"""
        \new Staff
        {
        ...
        """)
    staff = abjad.Staff(r"\times 2/3 {c'2 d'1}" r"\times 2/3 {e'2} \times 2/3 {f'1}")
    abjad.mutate.auto_rewrite_meter(staff, merge_partial_tuplets=False)
    assert abjad.lilypond(staff) == abjad.String.normalize(r"""
        \new Staff
        {
            \times 2/3
