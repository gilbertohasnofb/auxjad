...
def test_selection_is_full_01():
    ...
    assert auxjad.selection_is_full(container1[:])
    assert not auxjad.selection_is_full(container2[:])
    assert not auxjad.selection_is_full(container3[:])
    assert auxjad.selection_is_full(container4[:])
...
def test_selection_is_full_02():
    ...
    assert auxjad.selection_is_full(container1[:])
    assert auxjad.selection_is_full(container2[:])
    assert not auxjad.selection_is_full(container3[:])
    assert not auxjad.selection_is_full(container4[:])
...
def test_selection_is_full_03():
    ...
    assert auxjad.selection_is_full(container[:])
