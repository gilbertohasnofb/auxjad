...
their |doc|_ attribute), and full documentation with examples is available at the `Auxjad Docs`_
webpage. Note that Auxjad targets `Abjad 3.4`_ specifically and is not compatible with newer Abjad
releases.
