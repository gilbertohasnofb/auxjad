...
def test_sync_containers_01():
    ...
    assert abjad.get.duration(container1) == abjad.get.duration(container2)
...
def test_sync_containers_07():
    ...
    assert (
        abjad.get.duration(container1)
        == abjad.get.duration(container2)
        == abjad.get.duration(container3)
        == abjad.get.duration(container4)
    )
    assert abjad.lilypond(container1) == abjad.String.normalize(r"""
        \new Staff
        {
