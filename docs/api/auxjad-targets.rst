...
.. |abjad.mutate.reposition_clefs()| replace:: :meth:`abjad.mutate.reposition_clefs() <auxjad.Mutation.reposition_clefs>`
.. |abjad.mutate.reposition_dynamics()| replace:: :meth:`abjad.mutate.reposition_dynamics() <auxjad.Mutation.reposition_dynamics>`
.. |abjad.mutate.reposition_slurs()| replace:: :meth:`abjad.mutate.reposition_slurs() <auxjad.Mutation.reposition_slurs>`
.. |abjad.mutate.respell_accidentals()| replace:: :meth:`abjad.mutate.respell_accidentals() <auxjad.Mutation.respell_accidentals>`
.. |abjad.mutate.rests_to_multimeasure_rest()| replace:: :meth:`abjad.mutate.rests_to_multimeasure_rest() <auxjad.Mutation.rests_to_multimeasure_rest>`
...
.. |abjad.get.extract_time_signatures()| replace:: :meth:`abjad.get.extract_time_signatures() <auxjad.Inspection.extract_time_signatures>`
.. |abjad.get.selection_is_full()| replace:: :meth:`abjad.get.selection_is_full() <auxjad.Inspection.selection_is_full>`
.. |abjad.get.selections_are_identical()| replace:: :meth:`abjad.get.selections_are_identical() <auxjad.Inspection.selections_are_identical>`
.. |abjad.get.leaves_are_tieable()| replace:: :meth:`abjad.get.leaves_are_tieable() <auxjad.Inspection.leaves_are_tieable>`
.. |abjad.get.underfull_duration()| replace:: :meth:`abjad.get.underfull_duration() <auxjad.Inspection.underfull_duration>`
...
.. |auxjad.get.extract_time_signatures()| replace:: :meth:`auxjad.get.extract_time_signatures() <auxjad.extract_time_signatures>`
.. |auxjad.get.selection_is_full()| replace:: :meth:`auxjad.get.selection_is_full() <auxjad.Inspection.selection_is_full>`
.. |auxjad.get.selections_are_identical()| replace:: :meth:`auxjad.get.selections_are_identical() <auxjad.Inspection.selections_are_identical>`
.. |auxjad.get.leaves_are_tieable()| replace:: :meth:`auxjad.get.leaves_are_tieable() <auxjad.Inspection.leaves_are_tieable>`
.. |auxjad.get.underfull_duration()| replace:: :meth:`auxjad.get.underfull_duration() <auxjad.Inspection.underfull_duration>`
