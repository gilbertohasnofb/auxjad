...
def test_extend_notes_02():
    staff = abjad.Staff(r"\time 3/4 c'8 r8 r2 r4 <d' e' f'>4 r4 r8 g'16 r16 r2")
...
def test_extend_notes_05():
    staff = abjad.Staff(r"c'16\ppp r2... d'16\ff r2... e'16\f r2... f'16\mp r2...")
    auxjad.mutate.extend_notes(staff, abjad.Duration((3, 4)))
    assert abjad.lilypond(staff) == abjad.String.normalize(r"""
        \new Staff
        {
...
def test_extend_notes_06():
    staff = abjad.Staff(r"r16 c'16 r4. r16 d'16 r4. r16 e'16 r4. r16 f'16 r4.")
    auxjad.mutate.extend_notes(staff, abjad.Duration((1, 4)))
    assert abjad.lilypond(staff) == abjad.String.normalize(r"""
        \new Staff
        {
        ...
        """)
    staff = abjad.Staff(r"r16. c'32 r4. r16. d'32 r4. r16. e'32 r4. r16. f'32 r4.")
    auxjad.mutate.extend_notes(staff, abjad.Duration((1, 4)))
    assert abjad.lilypond(staff) == abjad.String.normalize(r"""
        \new Staff
        {
...
def test_extend_notes_07():
    staff = abjad.Staff(r"\time 3/4 c'16 r8. r2 \time 2/4 d'8 r8 e'8 r8 \time 3/4 r2 f'16 r8.")
    auxjad.mutate.extend_notes(staff, abjad.Duration((3, 4)))
    assert abjad.lilypond(staff) == abjad.String.normalize(r"""
        \new Staff
        {
...
def test_extend_notes_11():
    staff = abjad.Staff(r"r8 c'8 r2. r8 " r"d'8 ~ d'4 r2 " r"r16 e'8. ~ e'4 r2 " r"r16 f'8. ~ f'2.")
    auxjad.mutate.extend_notes(staff, abjad.Duration((3, 4)))
    assert abjad.lilypond(staff) == abjad.String.normalize(r"""
        \new Staff
        {
